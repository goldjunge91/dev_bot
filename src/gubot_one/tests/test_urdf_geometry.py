...
# ALT: os.path.join(_TEST_DIR, "..", "description", "gubot_one_main.urdf.xacro")
# — falscher Pfad, description liegt unter src/gubot_one/description/urdf/
_TEST_DIR = os.path.dirname(os.path.abspath(__file__))
XACRO_PATH = os.path.join(
    _TEST_DIR, "..", "description", "urdf", "gubot_one_main.urdf.xacro"
)
