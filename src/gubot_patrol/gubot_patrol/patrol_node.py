...
class PatrolNode(Node):
    ...
    cmd_vel_tracker automatically preempts it the moment a face
    ...
    def __init__(self):
        ...
        self.num_legs = self.get_parameter("num_legs").get_parameter_value().integer_value
        ...
        self.set_enabled_srv = self.create_service(SetBool, "~/set_enabled", self._on_set_enabled)
