...
This node is designed to provide a ros2_control hardware interface for an Arduino or Rasberry Pi Pico running firmware from `ros_arduino_bridge`.
...
- [ ] Add Document for Raspberry pi Pico
