...
// PIN DEFINITIONS
// =============================================================================
#define ESC_MOTOR_1_PIN 5
#define ESC_MOTOR_2_PIN 6
#define SHOT_SERVO_PIN 9
...
void processCommand(String cmd) {
  ...
  if (cmd == "ARM") {
    ...
    debugPrint("Unknown command. Available: ARM, DISARM, SHOT, ESC, TILT, "
               "STOP, STATUS");
  }
}
...
void setup() {
  ...
  debugPrint("Commands: ARM, DISARM, SHOT [power], ESC <power>, TILT <angle>, "
             "STOP, STATUS");
  debugPrint("=================================");
}
