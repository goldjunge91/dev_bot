...
def generate_launch_description():
    ...
    world_arg = DeclareLaunchArgument(
        "world",
        default_value=os.path.join(pkg_nerf, "worlds", "obstacles.world"),  # Standard-Welt mit Hindernissen
    ...
    node_robot_state_publisher = Node(
        ...
        output="screen",
        parameters=[robot_description, {"use_sim_time": True}],  # Simulationszeit verwenden
    )
    ...
    joint_state_broadcaster_spawner = Node(
        ...
        executable="spawner",
        arguments=["joint_state_broadcaster"],  # Publiziert Joint-States auf /joint_states
        output="screen",
    )
