...
static void print_banner() {
    ...
    Serial.printf("Baud: %d | PID: Kp=%d Kd=%d Ki=%d Ko=%d | AutoStop: %dms\n",
                  BAUD_RATE,
                  DEFAULT_KP,
                  DEFAULT_KD,
                  DEFAULT_KI,
...
void loop() {
    ...
    // ---- Auto-stop watchdog ----
    int64_t since_cmd_ms = absolute_time_diff_us(last_motion_cmd, get_absolute_time()) / 1000;
