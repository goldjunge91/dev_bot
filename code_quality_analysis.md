...
> **Analysed Packages:** `gubot_one` · [nerf_standalone](file:///home/ros/projects/my_new_robot/src/nerf_standalone/hardware/include/nerf_standalone) · `ball_tracker` · `diffdrive_arduino`
> **Date:** 2026-03-04
...
## 1 · `ball_tracker` Package

### 🔴 Critical Issues

#### 1.1 Unused import `Pose2D` in [detect_face.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/detect_face.py)
- **File:** [detect_face.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/detect_face.py#L20)
...
| File | Line | Code |
|------|------|------|
| [detect_ball.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/detect_ball.py#L73) | 73, 108 | `print(e)` in exception handlers |
| [detect_ball_3d.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/detect_ball_3d.py#L84) | 84 | `print(m.pose.position)` – debug output in production |
| [follow_ball.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/follow_ball.py#L59) | 59 | `print(self.target_dist)` – debug output |
| [fake_face_publisher.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/fake_face_publisher.py#L70) | 70 | `print(f"Error: {e}")` in exception handler |

- **Impact:** `print()` bypasses the ROS2 logging system – no timestamps, no level filtering, no `rqt_console` visibility.

### 🟠 Major Issues

#### 1.3 Empty `pass` block with commented-out log in [fire_at_face.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/fire_at_face.py)
- **File:** [fire_at_face.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/fire_at_face.py#L119-L121)
...
#### 1.4 Unused `sys` import in [fake_face_publisher.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/fake_face_publisher.py)
- **File:** [fake_face_publisher.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/fake_face_publisher.py#L6)
- **Line 6:** `import sys` is imported but never used.

#### 1.5 Mixed [process_image.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py) – combines ball-detection AND face-detection utilities
- **File:** [process_image.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py)
- Old ball-detection functions (`find_circles`, [apply_search_window](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#94-112), [draw_window2](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#116-128), [convert_rect_perc_to_pixels](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#130-141), [normalise_keypoint](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#143-153), [create_tuning_window](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#155-169), [get_tuning_params](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#171-187), [wait_on_gui](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#189-191), [no_op](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#193-195)) **are still present** alongside the newer face-detection functions ([load_encodings](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#11-20), [find_and_identify_faces](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#22-46), [draw_face_boxes](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#48-75), [normalise_face](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#77-90)).
- The ball-tracking functions like `find_circles` are **referenced** by [detect_ball.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/detect_ball.py) so they cannot be removed, but this file is doing double duty.
- **Impact:** Low cohesion. The file mixes two unrelated concerns. Consider splitting into `process_ball.py` and `process_face.py`.

#### 1.6 `find_circles` function is missing from [process_image.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py)
- **File:** [detect_ball.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/detect_ball.py#L79) calls `proc.find_circles(cv_image, self.tuning_params)` but `find_circles` **is not defined** in [process_image.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py).
...
- [detect_ball.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/detect_ball.py) uses bare `print(e)` for CvBridge errors.
- [detect_face.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/detect_face.py) correctly uses `self.get_logger().error()`.
- [follow_face.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/follow_face.py) and [fire_at_face.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/fire_at_face.py) use proper logging.

#### 1.8 [udp_cam_receiver.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/udp_cam_receiver.py) logs every received frame at INFO level
- **File:** [udp_cam_receiver.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/udp_cam_receiver.py#L50)
...
- Found at: [ball_tracker/ball_tracker/__pycache__/](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/__pycache__), [ball_tracker/test/__pycache__/](file:///home/ros/projects/my_new_robot/src/ball_tracker/test/__pycache__)
- **Impact:** Should be in `.gitignore` and removed from version control.

#### 1.10 [register_face.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/register_face.py) does not spin – runs blocking in [__init__](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/detect_ball_3d.py#23-41)
- **File:** [register_face.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/register_face.py#L60)
...
#### 2.3 [setup.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/setup.py) has TODO placeholders
...
- **Line 172:** `sys.exit()` is called on CTRL-C directly from the loop callback, which bypasses [destroy_node()](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/udp_cam_sender.py#70-74) and `rclpy.shutdown()` in the `finally` block.
...
- **Line 78:** `std::string response = send_msg("\r");` – the [response](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/fire_at_face.py#134-143) is captured but never used.
...
- All member variables (`name`, [enc](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#11-20), `cmd`, `pos`, `vel`, `rads_per_count`) are public. This is common in ROS2 hardware interfaces (used as simple data containers), so this is acceptable but noted.
...
- Found in `ball_tracker`, `gubot_one`, [nerf_standalone](file:///home/ros/projects/my_new_robot/src/nerf_standalone/hardware/include/nerf_standalone), and `serial` packages.
...
| File | What | Type |
|------|------|------|
| [detect_face.py:20](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/detect_face.py#L20) | `import Pose2D` | Unused import |
| [fake_face_publisher.py:6](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/fake_face_publisher.py#L6) | `import sys` | Unused import |
...
| [arduino_comms.hpp:78](file:///home/ros/projects/my_new_robot/src/diffdrive_arduino/hardware/include/diffdrive_arduino/arduino_comms.hpp#L78) | [response](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/fire_at_face.py#134-143) in [send_empty_msg()](file:///home/ros/projects/my_new_robot/src/diffdrive_arduino/hardware/include/diffdrive_arduino/arduino_comms.hpp#77-80) | Unused variable |
| [fire_at_face.py:119-121](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/fire_at_face.py#L119-L121) | `else: pass` + commented log | Dead branch |
...
| [process_image.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#L92-L194) | [apply_search_window](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#94-112), [draw_window2](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#116-128), [convert_rect_perc_to_pixels](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#130-141), [normalise_keypoint](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#143-153), [create_tuning_window](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#155-169), [get_tuning_params](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#171-187), [wait_on_gui](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#189-191), [no_op](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py#193-195) | Ball-tracking helpers – possibly still used by [detect_ball.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/detect_ball.py) but `find_circles` is **missing** |
...
### Immediate (Fix Bugs)
1. **Fix or restore `find_circles` in [process_image.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py)** – [detect_ball.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/detect_ball.py) will crash without it
...
9. Split [process_image.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/ball_tracker/process_image.py) into `process_ball.py` + `process_face.py`
...
13. Fill in [setup.py](file:///home/ros/projects/my_new_robot/src/ball_tracker/setup.py) TODO descriptions
